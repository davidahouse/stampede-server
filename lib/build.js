 ...
 * @param {*} serverConf
 */
async function startBuild(buildDetails, scm, scmDetails, repoConfig, tasks, cache, serverConf) {
  ...
  task.startTasks(buildDetails.owner, buildDetails.repo, buildDetails.buildKey, buildDetails.sha,
    tasks, buildPath, buildNumber, scm, scmDetails, cache, repoConfig, serverConf)
}
