...
const repositorySelectConfigSource = require("../controllers/repositories/selectConfigSource");
...
const repositoryRepositoryBuildDetails = require("../controllers/repositories/repositoryBuildDetails");
const repositoryUploadRepositoryBuild = require("../controllers/repositories/uploadRepositoryBuild");
const repositoryRemoveRepositoryBuild = require("../controllers/repositories/removeRepositoryBuild");
const repositoryExecuteRepositoryBuild = require("../controllers/repositories/executeRepositoryBuild");
...
function router(dependencies) {
  ...
  const conf = dependencies.serverConfig;
  const cache = dependencies.cache;
  const db = dependencies.db;
  const path = dependencies.viewsPath;
  const redisConfig = dependencies.redisConfig;
  ...
  basicRouter.post("/repositories/executeTask", function(req, res) {
    repositoryExecuteTask.handle(req, res, dependencies);
  });

  basicRouter.post("/repositories/toggleConfigSource", function(req, res) {
  ...
  basicRouter.get("/repositories/selectConfigSource", function(req, res) {
    repositorySelectConfigSource.handle(req, res, cache, db, path);
  });
  ...
  basicRouter.get("/repositories/repositoryBuildDetails", function(req, res) {
    repositoryRepositoryBuildDetails.handle(req, res, cache, db, path);
  });

  basicRouter.post("/repositories/uploadRepositoryBuild", function(req, res) {
    repositoryUploadRepositoryBuild.handle(req, res, cache, db, path);
  });

  basicRouter.get("/repositories/removeRepositoryBuild", function(req, res) {
    repositoryRemoveRepositoryBuild.handle(req, res, cache, db, path);
  });

  basicRouter.get("/repositories/executeRepositoryBuild", function(req, res) {
    repositoryExecuteRepositoryBuild.handle(req, res, dependencies);
  });
